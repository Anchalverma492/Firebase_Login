...
public final class EncryptedSharedPreferences implements SharedPreferences
{
    ...
    private static final String SHARED_PREF_NAME = "zipValid";
    private static final String USER_ID = "user_id";
    private static final String REFRENCE_NO = "refrence_no";
    ...
    private static final String WITH_VALIDATEACCID = "withValidateAccountID";
    private static final String SYNC_DATA = "SYNC_DATA";
    private static final String logInValue = "loggedInValue";
    ...
    public EncryptedSharedPreferences(@NonNull String name,
    ...
    public static EncryptedSharedPreferences getInstance(android.content.Context context) {
      Context=context;
      return null;
    }

    public Boolean saveValue(String data) {
        SharedPreferences.Editor editor = edit();
        editor.putString(Sync_Value, data);
        editor.apply();
       return true;
    }
    public String getsaave() {

        String decryptString = getString(WITH_VALIDATEACCID, "");
    ...
    /*
        public boolean saveSyncValue(int syncValue) {
            SharedPreferences.Editor editor1= edit();
            editor1.putInt(Sync_Value, syncValue);
            editor1.apply();
            return true;
        }
